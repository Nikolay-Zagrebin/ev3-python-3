...
def calc_speed_motors(new_coor_list):
    ...
    move_coor_list[4] = new_coor_list[4] - round((yaw_arm.angle() / yaw_arm_gear) - (round(roll_arm.angle() / roll_arm_gear * 20 / 12, 2) / roll_arm_gear), 2)
    ...
    move_angle_list[4] = math.fabs(int((move_coor_list[4] * yaw_arm_gear) + (move_coor_list[3] / roll_arm_gear * 20 / 12 * yaw_arm_gear)))
...
def move_all_motors_two():
    ...
    pitch_base.run_target(actuation_list[7], int(actuation_list[1] * pitch_base_gear * th2_switch), then=Stop.HOLD, wait=False)            #then=Stop.COAST
    pitch_arm.run_target( actuation_list[8], int(actuation_list[2] * pitch_arm_gear *  th3_switch), then=Stop.HOLD, wait=False)            #then=Stop.COAST
...
# while True:
#     next_coordinate_linear( 170, -205,  225,    0,    0,    0, 700)   
#     next_coordinate_linear( 174,  136,   90,    0,    0,    0, 700)
#     next_coordinate_linear(  10,  136,   90,    0,    0,    0, 700)
#     next_coordinate_linear( 270,  136,   90,    0,    0,    0, 700)
#     next_coordinate_linear( 270,  136,  370,    0,    0,    0, 700)
#     next_coordinate_linear( 270, -136,  370,    0,    0,    0, 700)
...
# while True:
#     next_coordinate_linear( 174,    0,   90,    0,   45,    0, 700)   
#     next_coordinate_linear( 174,  136,   90,    0,   45,    0, 700)
#     next_coordinate_linear(  10,  136,   90,    0,    0,    0, 700)
#     next_coordinate_linear( 270,  136,   90,    0,    0,    0, 700)
#     next_coordinate_linear( 270,  136,  370,    0,    0,    0, 700)
#     next_coordinate_linear( 270, -136,  370,    0,    0,    0, 700)
